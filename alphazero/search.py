...
class Search:
    ...
    async def step(self) -> None:
        ...
        if state_node.raw_value is None:
            ...
            state_node.action_nodes = [
                ActionNode(action, raw_policy) for action, raw_policy in prediction.policy.items()
            ]
    ...
    def prediction(self) -> Prediction:
        ...
        policy = {
            action_node.action: action_node.visit_count / total_visit_count for action_node in state_node.action_nodes
        }
